...
// Create a test for ParalutionWrappers::SolverGMRES
...
int main()
{
  ...
  ParalutionWrappers::SolverGMRES solver(control);
  ...
  for (unsigned int size=4; size<=30; size*=3)
  {
    ...
    //Preconditioner
    ParalutionWrappers::PreconditionMultiColoredSOR<double> p(1.);
