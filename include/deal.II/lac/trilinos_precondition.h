...
namespace TrilinosWrappers
{
   ...
   *
   * This class requires Trilinos 11.12 or higher.
   *
  ...
  public:
    ...
    struct AdditionalData
    {
      ...
      const char *coarse_type;
//-----------------------------------------------------------------------------------
//    // Use the new options of MueLu
//      /**
//       * Constructor. By default, we pretend to work on elliptic problems with
//       * linear finite elements on a scalar equation.
//       */
//      AdditionalData (const bool                             symmetric = true,
//                      const std::string                      multigrid_algorithm = "sa",
...
//                      const std::string                      coarse_type = "KLU");
//
//      /**
//       * If set to true, the restrictor is set to be the transpose of a
//       * prolongator. If set to false, the underlying mutligrid algorithm makes
//       * the decision.
//       */
//      bool symmetric;
//
...
//       * Multigrid method:
//       * <ul>
//       *   <li> "sa" = classical smoothed aggregation </li>
//       *   <li> "unsmoothed" = aggregation-based, same as "sa" but without
//       *   damped Jacobi prolongator improvement step </li>
//       *   <li> "pg" = prolongator smoothing using A, restriction smoothing
//       *   using the transpose of A, local damping factor </li>
//       *   <li> "emin" = constrained minimization of energy in basis functions
//       *   of grid transfer operator</li>
//       * </ul>
//       */
//      std::string multigrid_algorithm;
//
//      /**
//       * Defines whether a w-cycle should be used instead of the standard
//       * setting of a v-cycle.
