...
// @sect3{The <code>Step60</code> class template}
...
// @sect3{The <code>Step60</code> class implementation}
...
// above. The reason is that member variables of the <code>Step60</code> class
...
// worry about.
template <int dim>
void Step60<dim>::assemble_system ()
{
...
// for that case):
template <int dim>
void Step60<dim>::output_results (const unsigned int cycle) const
{
